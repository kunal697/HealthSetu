    ...
    <section className="py-24 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          Every action matters. Whether you're booking an appointment or syncing your health data, you're contributing to a smarter and healthier future.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl transform transition-transform group-hover:scale-[1.02]" />
          ...
          >
            ...
            <div className="relative bg-white rounded-2xl p-8 shadow-lg transform transition-transform">
              ...
              <h3 className="text-2xl font-bold mb-4">Sync Your Health Data</h3>
              <p className="text-gray-600 mb-6">
